...
//        studentController.loadDepartmentList();
...
//                Department: "Yêu cầu nhập tên khoa"
//            }
//        });
...
//                } else {
//                    studentController.checkExist(Name);
//                }
//            }
//        });
...
//                    $('input[name=Gender]').val(item.Gender).prop('checked');
...
//                            Name: item.Name,
//                            Avatar: item.Avatar,
//                            Gender: item.Gender === 1 ? "Nam" : (item.Gender === 0 ? "Nữ" : "Khác"),
...
var studentController = {
    init: function () {
        studentController.loadData();
        studentController.loadRoomList();
        studentController.registerEvent();
    },
    registerEvent: function () {
